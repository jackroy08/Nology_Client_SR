...
import {operatorUsersArr} from "../../data/users";
...
export const Supervisor = () => {
    ...
    <main className={Styles.pageGrid}>
        ...
        <section className={Styles.buttonGrid}>
            ...
            <div><button className={`${Styles.btnPrimary} ${Styles.btn}`} onClick={()=>{setIsOverlayShown(true); setOverlayContent(<AssignVehicles setIsOverlayShown={setIsOverlayShown} setOverlayContent={setOverlayContent} operatorUsersArr={operatorUsersArr} vehicleData={vehicleData}/>)}}>Reassign Vehicles</button></div>
